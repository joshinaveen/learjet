                        ...
                        <tbody>
                            <?php foreach ($types as $type): ?>
                                <tr>
                                    ...
                                    <td><?= $type->has('family') ? $this->Html->link($type->family->family, ['controller' => 'Families', 'action' => 'edit', $type->family->id]) : '' ?></td>
                                    <td><?= h($type->type) ?></td>
                                    <td>
                                        <i class="fa <?php echo $type->active ? 'fa-check text-navy' : 'fa-times text-danger'; ?>"></i>
                                    </td>
